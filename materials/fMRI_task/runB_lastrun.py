...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.83.04), May 24, 2016, at 15:40
...
expName = 'runB'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Documents and Settings\\fmri\\Desktop\\PsychNet\\random_order\\ANDY\\runB.psyexp',
...
loop_trials = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('runB.csv'),
